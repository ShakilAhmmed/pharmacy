...
@section('breadcrumbs','Whole Sale Report')
            ...
            <div class="animated fadeIn">
                <div class="row">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <tr>
												@foreach($whole_sale_data as $whole_sale_data_value)
                        <td>{{date('d-M-Y',strtotime($whole_sale_data_value->date))}}</td>
                        <td>{{$whole_sale_data_value->invoice_id}}</td>
                        <td>{{$whole_sale_data_value->patient_name}}</td>
                        <td>{{$whole_sale_data_value->grand_total}}</td>
                        <td style="display: inline-flex;">
             {{Form::submit('View',['class'=>'btn btn-primary invoice_print','data-toggle'=>'modal','data-target'=>'#myModal','get_value'=>"$whole_sale_data_value->invoice_id"])}}
                      {{Form::open(['url'=>"/whole_sale_report/$whole_sale_data_value->invoice_id",'method'=>'DELETE'])}}
