...
<div>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
       {{Form::open(['url'=>'/expense_catagory','method'=>'post'])}}
      <div class="modal-content">
        ...
        <div class="form-group">
	      ...
	      <div class="col-sm-10">
	      {{Form::text('expense_name','',['class'=>'form-control','id'=>'expense_name','title'=>'expense_name'])}}
	      </div>
        </div>
        ...
        <div class="form-group">
	      ...
	      <div class="col-sm-10">
	      {{Form::textarea('expense_description','',['class'=>'form-control','id'=>'expense_description','title'=>'expense_description','cols'=>'4','rows'=>'4'])}}
	      </div>
        </div>
       <div class="form-group">
	      <label class="control-label col-sm-6" for="email">Expense Status:</label>
	      <div class="col-sm-10">
	       {{Form::select('expense_status',['Active'=>'Active','Inactive'=>'Inactive'],null,['class'=>'form-control','title'=>'expense_status'])}}
	      </div>
      </div>
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>{{$key+1}}</td>
                        <td>{{$expense_data_value->expense_name}}</td>
                        <td>{{$expense_data_value->expense_description}}</td>
                        <td>
												@if($expense_data_value->expense_status=='Active')
                          <span style="color: green;">{{$expense_data_value->expense_status}}</span>
												@else
												<span style="color: red;">{{$expense_data_value->expense_status}}</span>
												@endif
                         </td>
                        <td style="display: inline-flex;">
                          {{Form::open(['url'=>"/expense_catagory/$expense_data_value->expense_catagory_id/edit",'method'=>'GET'])}}
                           {{Form::submit('EDIT',['class'=>'btn btn-primary'])}}
                          {{Form::close()}}

                          @if($expense_data_value->expense_status=='Active')
                          {{Form::open(['url'=>"/expense_catagory/$expense_data_value->expense_catagory_id",'method'=>'GET'])}}
                          ...
                          {{Form::open(['url'=>"/expense_catagory/$expense_data_value->expense_catagory_id",'method'=>'DELETE'])}}
